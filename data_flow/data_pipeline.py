...
# 登录函数
def login_tinysoft():
    # Read credentials from environment for open-source safety
    username = os.getenv("TSL_USERNAME", "your_username")
    password = os.getenv("TSL_PASSWORD", "your_password")
...
if __name__ == "__main__":
    ...
    if all_data:
        ...
        from utils.json_file_manager import safe_write_json
